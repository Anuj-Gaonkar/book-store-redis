...
import com.gaonkar.anuj.bookstore.model.Cart;
import com.gaonkar.anuj.bookstore.model.User;
import com.gaonkar.anuj.bookstore.repository.BookRatingRepository;
...
@Order(4)
@Slf4j
public class CreateAppRatings implements CommandLineRunner {
